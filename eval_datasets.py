...
error_rw[0,0],error_rw[0,1],error_rw[0,2],error_rw[0,3],error_rw[0,4]=crossval("calabria.csv")
error_rw[1,0],error_rw[1,1],error_rw[1,2],error_rw[1,3],error_rw[1,4]=crossval("cretaceous.csv")    
error_rw[2,0],error_rw[2,1],error_rw[2,2],error_rw[2,3],error_rw[2,4]=crossval("texas.csv")
error_rw[3,0],error_rw[3,1],error_rw[3,2],error_rw[3,3],error_rw[3,4]=crossval("amazon.csv")    
